...
<div id="contaniner" class="">
	...
	<form action="../community/pageContentsReply"  method="post" id="frm">
		<input type="hidden" id="page_num"  name="page_num" value="${dto.page_num}">
		<div id="top_contents">
		<img alt="" src="">
		<p>${dto.id}님이 글을 올렸습니다.</p><br>
		<p>${dto.reg_date} </p>
		</div>
		<div id="pageContetns">
			${dto.contents}
