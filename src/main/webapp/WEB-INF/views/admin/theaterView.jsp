		...
		<c:import url="${pageScope.pageContext.request.contextPath }/WEB-INF/views/temp/header.jsp"></c:import>
			...
			<input type="hidden" name="theater_num" id="theater_num" value="${theaterDTO.theater_num }">
				<table  class="revisionTable">
					<tr>
						<td>지역</td>
						<td><input type="text" class="noneBorder" name="area" value="${theaterDTO.area }" readonly="readonly"></td>
					</tr>
					<tr>
						<td>지점</td>
						<td><input type="text" class="noneBorder"  name="location" value="${theaterDTO.location }" readonly="readonly"></td>
					</tr>
					<tr>
						<td>위도</td>
						<td><input type="text" class="noneBorder" name="x_position" value="${theaterDTO.x_position }"></td>
					</tr>
					<tr>
						<td>경도</td>
						<td><input type="text" class="noneBorder" name="y_position" value="${theaterDTO.y_position }"></td>
					</tr>
				</table>
				<div class="set-btn">
