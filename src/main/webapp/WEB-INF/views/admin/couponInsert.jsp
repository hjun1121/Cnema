		...
		<c:import url="${pageScope.pageContext.request.contextPath }/WEB-INF/views/temp/header.jsp"></c:import>
			...
			<form action="./couponInsert" name="frm" method="POST">				
				<table  class="revisionTable">
					<tr>
						<td>쿠폰이름</td>
						<td><input type="text" id="name" name="name" class="noneBorder"></td>
					</tr>
					<tr>
						<td>쿠폰타입</td>
						<td>
							<select id="f" name="type" >
					...
					<tr>
						<td>금액</td>
						<td><input type="text" id="price" name="price" class="noneBorder"></td>
					</tr>
					<tr>
						<td>유효기간</td>
						<td><input type="number" id="v_day" name="v_day" class="noneBorder"></td>
					</tr>
					
				</table>
				<div class="set-btn">
					<input type="button" id="cBtn" class="round inred on" style="width: 58px;" value="등록">
			        <a href="../admin/couponList" class="round gray"><span>취소</span></a>
			    </div>
			</form>
